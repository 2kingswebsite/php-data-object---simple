...
<body>
  ...
  <div class="container">
    ...
    <div class="right-pane">
      <h2>Data -- Live Search with JS</h2>

      <form method="POST">
        <input type="text" name="name" placeholder="Search Name -- Live search" class="gt-input rounded-left rounded-right" onkeyup="searchNames(this.value)">
      </form>
